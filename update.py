...
rss_url = 'https://pubmed.ncbi.nlm.nih.gov/rss/search/1NIs-Zi-UW0nwKDBIz3oujnQrgsZ8yKGRRp_B2JuZehAQSZYSd/?limit=100&utm_campaign=pubmed-2&fc=20260313055125'

access_token = os.getenv('GITHUB_TOKEN')
deepseekaikey = os.getenv('DEEPSEEK_API_KEY')

client = openai.OpenAI(api_key=deepseekaikey, base_url="https://api.deepseek.com") # if you use deepseek api key, change to: client = openai.OpenAI(api_key=openaiapikey, base_url="https://api.deepseek.com")
...
def create_github_issue(title, body, access_token):
    url = f"https://api.github.com/repos/Uzzing-1/AutoAIScore/issues"
    headers = {
